...
*/
	...
	public static void main(String[] args) {
		...
		AVL<Integer, String> st = new AVL<Integer, String>();
	 	...
	 	st.put(6, "Apple"); st.print(st.root);

	 	st.put(5, "Grape"); st.print(st.root);

	 	st.put(4, "Lime"); st.print(st.root);

	 	st.put(2, "Mango"); st.print(st.root);

	 	st.put(3, "Strawberry");st.print(st.root);



	 	st.delete(6);st.print(st.root);
