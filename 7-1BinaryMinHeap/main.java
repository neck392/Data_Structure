...
*/
		...
		h.insert(10,"apple"); System.out.println("8  삽입 후"); h.print();
		h.insert(50,"apple"); System.out.println("4  삽입 후"); h.print();
		h.insert(20,"apple"); System.out.println("7  삽입 후"); h.print();
		h.insert(60,"apple"); System.out.println("3  삽입 후"); h.print();
		h.insert(70,"apple"); System.out.println("6  삽입 후"); h.print();
		h.insert(40,"apple"); System.out.println("2  삽입 후"); h.print();
		h.insert(80,"apple"); System.out.println("5  삽입 후"); h.print();
